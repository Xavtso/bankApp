...
const account5 = {
  owner: 'Ivanna Barabash',
  movements: [600, 1000, 8000, 80, 90, 800, 9000, 700, 50, 90],
  interestRate: 2,
  pin: 1818, 
  movementsDates: [
    '2022-11-01T13:15:33.035Z',
...
// Package with most duplicates functions
...
btnLoan.addEventListener('click', function (e) {
  ...
  if (amount > 0 && currentAccount.movements.some(mov => mov >= amount * 0.1)) {
    ...
    currentAccount.movements.some(mov => mov >= amount * 0.1) === false
  ) {
    alert(`You can't get this loan!`);
